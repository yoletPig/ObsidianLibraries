...
```mermaid
flowchart LR
    A["图片<br/>3×336×336"] -->|"Conv2d k=14 s=14<br/>= Patch Embedding"| B["576×1024<br/>(CLIP-L, 去CLS)"]
...
2. **1024 → 4096** = $d_v \to d_{llm}$ —— Projector 的维度对齐职责（CLIP ViT-L 的 $d_v=1024$；若用 SigLIP-SO400M 则为 1152）；
